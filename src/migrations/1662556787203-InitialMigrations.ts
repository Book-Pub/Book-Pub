...
export class InitialMigrations1662556787203 implements MigrationInterface {
    name = 'InitialMigrations1662556787203'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Ebooks" ADD CONSTRAINT "FK_cdf48141575b1e7200b9e803da2" FOREIGN KEY ("favoritesId") REFERENCES "favorites"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Ebooks" ADD CONSTRAINT "FK_b12673daf19bf15cae354d347f2" FOREIGN KEY ("cartId") REFERENCES "cart"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Ebooks" ADD CONSTRAINT "FK_8f8889b94342f206a002d9bde6d" FOREIGN KEY ("authorId") REFERENCES "author"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Ebooks" ADD CONSTRAINT "FK_aeb75b2969f5da7d7c9e1c03ab1" FOREIGN KEY ("categoriesId") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Ebooks" DROP CONSTRAINT "FK_aeb75b2969f5da7d7c9e1c03ab1"`);
        await queryRunner.query(`ALTER TABLE "Ebooks" DROP CONSTRAINT "FK_8f8889b94342f206a002d9bde6d"`);
        await queryRunner.query(`ALTER TABLE "Ebooks" DROP CONSTRAINT "FK_b12673daf19bf15cae354d347f2"`);
        await queryRunner.query(`ALTER TABLE "Ebooks" DROP CONSTRAINT "FK_cdf48141575b1e7200b9e803da2"`);

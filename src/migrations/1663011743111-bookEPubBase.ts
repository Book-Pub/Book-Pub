...
export class bookEPubBase1663011743111 implements MigrationInterface {
    name = 'bookEPubBase1663011743111'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order_ebooks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "orderId" uuid, "ebooksId" uuid, CONSTRAINT "PK_0907e07edcc0831bc76cf710504" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "order_ebooks" ADD CONSTRAINT "FK_4c38e2c02d5f4e5efadd153c91a" FOREIGN KEY ("ebooksId") REFERENCES "ebooks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order_ebooks" DROP CONSTRAINT "FK_4c38e2c02d5f4e5efadd153c91a"`);
